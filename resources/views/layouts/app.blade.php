            ...
            @php
                $nav = [
                    ...
                    ['heading' => 'Point of Sale', 'links' => [
                        ...
                        ['route' => 'pos.settings', 'label' => 'Register Display', 'perm' => 'pos.settings'],
                        ['route' => 'payment-methods.settings', 'label' => 'Payment Methods', 'perm' => 'pos.settings'],
                        ['route' => 'cash-reasons.settings', 'label' => 'Cash Reasons', 'perm' => 'pos.settings'],
                    ]],
